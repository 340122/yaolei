    ...
    <div id="page-wrapper">
        ...
        <div class="panel panel-default">
            <div class="panel-body" style="text-align: center">
                <form method="post" action="${pageContext.request.contextPath}/up.action" class="form-inline"><br><br>
                    <p><strong>修改当前账号密码</strong></p>
                    <div class="updateStudent" style="align-content: center">
                        <span style="margin-left: -149px">账户：${USER_SESSION.username}</span>
                        <input type="text" name="username" hidden="hidden" value="${USER_SESSION.username}">
                        <br>
                        密码：
                        <input type="password" name="password" ><br>
                        <input type="submit" value="修改" name="us" class="us">
                    </div>
                </form><br><br>
            </div>
        </div>
